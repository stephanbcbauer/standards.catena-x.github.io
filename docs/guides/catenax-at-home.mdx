...
slug: /catenax-at-home-getting-started-guide
---
...
To **try out the End-to-End** use case you need to import the Postman collection:
...
The Postman collection uses variables that are located at the collection level. You can view them in the `Variables` tab. 
