...
1. News from the DevSecOps Team
    1. We changed the DNS setup (the Hotel Budapest means the INT, thats now reflexted in the URL), but the old Domain ist redirected
...
1. News from the Security Team
    1. Some Veracode tipps and tricks
    1. Containerscanning in progress
1. Q&A
1. Hands-on
